...
class PANDataModule(L.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        data = Dataset_mat_rr(train_file_path, sattelite=self.satelite, channels=self.channels, img_scale=self.img_scale, highpass=self.highpass)
    ...
    def val_dataloader(self):
        ...
        data = Dataset_mat_rr(val_file_path, sattelite=self.satelite, channels=self.channels, img_scale=self.img_scale, highpass=self.highpass)
    ...
    def test_dataloader(self):
        ...
        data = Dataset_mat_rr(test_file_path, sattelite=self.satelite, channels=self.channels, img_scale=self.img_scale, highpass=self.highpass)
