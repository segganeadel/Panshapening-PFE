...
class MSDCNN_inst():
    def __init__(self, spectral_num, criterion, channel=64):
        self.model = MSDCNN(spectral_num, criterion, channel)
        path = os.path.join(os.path.dirname(os.path.dirname(__file__)),"weights","QB","msdcnn.pth") # up two directories to get to the weights folder
